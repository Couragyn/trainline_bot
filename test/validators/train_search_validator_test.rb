...
class TrainSearchValidatorTest < ActiveSupport::TestCase
  ...
  test "valid?: rejects date before minimum allowed date" do
    validator = TrainSearchValidator.new(
      from: "Madrid",
      to: "Barcelona",
      departure_at: "2026-02-15T09:00:00+01:00"
    )
    refute validator.valid?
  ...
  test "valid?: rejects date after maximum allowed date" do
    validator = TrainSearchValidator.new(
      from: "Madrid",
      to: "Barcelona",
      departure_at: "2027-02-23T09:00:00+01:00"
    )
    refute validator.valid?
  ...
  test "valid?: accepts date exactly at minimum allowed date" do
    validator = TrainSearchValidator.new(
      from: "Madrid",
to: "Barcelona",
      departure_at: "2026-02-16T00:00:00+01:00"
    )
    assert validator.valid?
  end
  ...
  test "valid?: accepts date exactly at maximum allowed date" do
    validator = TrainSearchValidator.new(
      from: "Madrid",
      to: "Barcelona",
      departure_at: "2027-02-22T00:00:00+01:00"
    )
    assert validator.valid?
  end
