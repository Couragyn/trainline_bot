...
class Bot::ThetrainlineTest < ActiveSupport::TestCase
  ...
  test "find returns results for Madrid to Barcelona from fixture" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    assert result.any?, "Should return at least one result from fixture data"
    assert_equal @fixture_segments.length, result.length
  end
  ...
  test "segment contains all required fields from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
  ...
  test "segment fields have correct types from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
  ...
  test "fares contain all required fields from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first

    assert segment[:fares].any?, "Should have at least one fare from fixture"
  ...
  test "fare fields have correct types from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
    fare = segment[:fares].first
  ...
  test "find is case-insensitive for cities in fixture data" do
    ...
    assert_equal result1.length, result3.length, "Results should match exact case"
  end
  ...
  test "service agencies contain valid values from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
  ...
  test "products contain valid values from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
  ...
  test "arrival time is after departure time in fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
  ...
  test "duration matches arrival and departure times from fixture data" do
    result = Bot::Thetrainline.find("Madrid", "Barcelona", @departure_date)
    segment = result.first
